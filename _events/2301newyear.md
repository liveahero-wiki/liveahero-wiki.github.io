...
|----|-----------------------------------------------------------|----------------|
| 1  | Finish any rank campaign quest 10 times | 10000 {% include item-icon.html id=11 %}    |
| 2  | Finish any rank campaign quest 20 times | 10000 {% include item-icon.html id=30 %}    |
| 3  | Finish any rank campaign quest 30 times | 12500 {% include item-icon.html id=11 %}    |
| 4  | Finish any rank campaign quest 45 times | 12500 {% include item-icon.html id=30 %}    |
| 5  | Finish any rank campaign quest 60 times | 15000 {% include item-icon.html id=11 %} ; 15000 {% include item-icon.html id=30 %} |
