...
Combo counter increase by one for every consecutive actions done by your heroes. Starting from combo 2 any view generated by active hero will be increased by 10% for each combo i.e.: 1.1x view at combo 2, 1.2x view at combo 3, etc. Combo will be reset to 1 when any enemy unit take action in battle.
>Certain heroes have skills that increase combo count ([Barrel](/charas/barrel/) /[Kyoichi](/charas/kyoichi/)) or skills that make use of combo count as damage multiplier ([Barrel](/charas/barrel/)/[Toshu](/charas/toshu/))
