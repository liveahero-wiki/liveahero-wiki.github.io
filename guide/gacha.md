...
Use 1000 {% include item.html id=42 %} for 10-Pull

Friend Point Gacha gives a variety of items such as: {% include item.html id=11 %}, {% include item.html id=35 %}, {% include item.html id=31 %}

The grand prize in Friend Gacha is a player sidekick dupe {% include item.html id=219991 %}.

Below is the drop rates for possible items tested empirically. (Credits for the data: Chase)
